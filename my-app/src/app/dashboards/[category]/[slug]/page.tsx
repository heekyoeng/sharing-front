...
import type { Category, ChartSlug, DashboardItem, KpiItem, TableRow } from 'types/dashboard';
import {
    useDisclosure,

} from '@chakra-ui/react';
import ChartModal from 'app/components/chart/ChartModal';
...
export default function Page(): JSX.Element {
  ...
  const slug = (typeof slugRaw === 'string' ? slugRaw : Array.isArray(slugRaw) ? slugRaw[0] : '') as ChartSlug;
